/**
 * Revert Options Modal Component
 *
 * Shows options when reverting to a message:
...
const RevertOptionsModal: React.FC<RevertOptionsModalProps> = ({
  isOpen,
  onClose,
        ...
        <div className="rounded-xl border border-slate-700 bg-slate-900 shadow-2xl">
          ...
          <div className="px-6 py-5 space-y-4">
            <p className="text-sm text-slate-300">
              Choose which model to use for continuing the conversation:
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-slate-400 mb-2">
                    Keep using your currently selected model
                  </div>
                  {currentModelInfo && (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-slate-400 mb-2">
                      Use the model that was active at this message
                    </div>
                    <div className="flex items-center gap-2">
                      <span className={`rounded-full px-2 py-0.5 text-[10px] ${
...
export default RevertOptionsModal;
