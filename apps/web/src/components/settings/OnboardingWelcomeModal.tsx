        ...
        <div className="relative w-full max-w-lg rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl">
          ...
          <div className="border-b border-slate-800 px-6 py-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-100">Welcome to AI Agent!</h2>
          ...
          <div className="px-6 py-6 space-y-5">
            ...
            <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-blue-200">Before you can chat with AI Agent</p>
                  <p className="mt-2 text-sm text-slate-300">
                    You need to add at least one API key below. This allows AI Agent to connect to AI models on your behalf.
                  </p>
                </div>
              </div>
            </div>
