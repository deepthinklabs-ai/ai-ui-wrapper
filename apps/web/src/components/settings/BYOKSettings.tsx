            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded-md border border-foreground/30 bg-white/60 px-4 py-2 text-sm font-medium text-foreground hover:bg-white/80 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                ...
                {isConfigured && (
                  <button
                    ...
                    disabled={isSaving || isDeleting}
                    className="rounded-md border border-foreground/30 bg-white/60 px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-500/10 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    {isDeleting ? "..." : "Remove"}
                  </button>
                )}
