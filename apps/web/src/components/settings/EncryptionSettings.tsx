      ...
      <div className="fixed inset-0 z-50 bg-white/95 backdrop-blur-md">
        <div className="absolute top-4 right-4">
          <button
            ...
            className="rounded-md p-2 text-foreground/60 hover:bg-white/60 hover:text-foreground transition-colors"
          >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-lg border border-green-500/30 bg-green-500/10 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-semibold text-green-700">Encryption Enabled</div>
                <div className="text-xs text-green-600">Your messages are protected with end-to-end encryption</div>
              </div>
            </div>
            {state.isUnlocked ? (
              <span className="inline-flex items-center gap-1 rounded-full bg-green-500/20 px-3 py-1 text-xs font-medium text-green-700">
                <span className="h-1.5 w-1.5 rounded-full bg-green-500"></span>
                Unlocked
              </span>
            ) : (
              <span className="inline-flex items-center gap-1 rounded-full bg-amber-500/20 px-3 py-1 text-xs font-medium text-amber-700">
          ...
          {state.remainingRecoveryCodes > 0 && (
            <div className="rounded-lg border border-white/30 bg-white/40 p-4">
              <div className="flex items-center justify-between">
                ...
                {state.remainingRecoveryCodes <= 3 && (
                  <span className="text-xs text-amber-600">Consider regenerating codes</span>
                )}
              </div>
            </div>
          )}
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-semibold text-amber-700">Encryption Not Set Up</div>
