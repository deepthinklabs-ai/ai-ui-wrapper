          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex items-center gap-2 rounded-lg border border-slate-600 bg-slate-700/50 px-3 py-2 text-sm font-medium text-slate-200 hover:bg-slate-700 transition-colors"
              >
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <aside className="lg:col-span-1 mb-6 lg:mb-0">
            <div className="rounded-lg border border-slate-700 bg-slate-800 p-4 sticky top-24">
              <ExchangeFilters
